...
public class IntakeTalonFX implements IntakeIO {
    ...
    public IntakeTalonFX(TalonFX driveMotor, StatusSignal<Voltage> driveVoltageSignal, StatusSignal<Temperature> driveTemperatureSignal, StatusSignal<Current> driveAppliedCurrentSignal, StatusSignal<Current> driveSupplyCurrentSignal, DoubleSolenoid solenoid) {
        this.driveMotor = driveMotor;
        this.driveVoltageSignal = driveVoltageSignal;
        this.driveTemperatureSignal = driveTemperatureSignal;
        this.driveAppliedCurrentSignal = driveAppliedCurrentSignal;
        this.driveSupplyCurrentSignal = driveSupplyCurrentSignal;
