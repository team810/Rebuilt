...
public class MopTalonFX implements MopIO {
    ...
    public MopTalonFX(TalonFX mopMotor, StatusSignal<Voltage> mopVoltageSignal, StatusSignal<Temperature> mopTemperatureSignal, StatusSignal<Current> mopAppliedCurrentSignal, StatusSignal<Current> mopSupplyCurrentSignal) {
        this.mopMotor = mopMotor;
        this.mopVoltageSignal = mopVoltageSignal;
        this.mopTemperatureSignal = mopTemperatureSignal;
        this.mopAppliedCurrentSignal = mopAppliedCurrentSignal;
        this.mopSupplyCurrentSignal = mopSupplyCurrentSignal;
    }
